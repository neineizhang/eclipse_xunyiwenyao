...
public class HTTPHelperTest {
	...
	public static void main(String[] args) {
		...
		//String param = "template_name=template2&creator_id=30&department=0&details_json=[{\"how_to_use\":\"hello\",\"count\":995,\"drug_id\":1}]";

		String url = "http://222.29.100.155/b2b2c/api/mobile/recipe/addRecpice.do";
		String param = "recipe_name=recepict4&creator_id=1&user_name=&user_age=0&user_sex=0&content=&status=1&create_time_text=2017-05-02 09:29:29&details_json=[{\"count\":5,\"how_to_use\":\"zll\",\"drug_id\":1}]";
		//String param = "template_name=test&creator_id=1&department=1&";
